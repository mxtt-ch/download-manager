        ...
        <TooltipProvider>
            <div className="flex flex-col gap-4">
                ...
                <div className="space-y-1.5">
                    ...
                    <div className="flex gap-2">
                        <Input
                            id="download-path"
                            value={form.savePath}
                            onChange={(e) => onUpdateField("savePath", e.target.value)}
                            className="flex-1"
                        />
                        <Tooltip>
                            <TooltipTrigger asChild>
                ...
                <div className="space-y-1.5">
                    ...
                    <Select
                        value={form.queueId}
                        onValueChange={(value) => onUpdateField("queueId", value)}
                    >
                        ...
                        <div className="mt-3 space-y-3 rounded-md border border-slate-200 dark:border-slate-700 p-3">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <Switch
                                    ...
                                    onCheckedChange={(v) => onUpdateField("enableResume", v)}
                                />
                            </div>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <Switch
                                    ...
                                    onCheckedChange={(v) => onUpdateField("autoStart", v)}
                                />
                            </div>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <Switch
                                    ...
                                    onCheckedChange={(v) =>
                                        onUpdateField("enableIntegrityCheck", v)
                                    }
                                />
                            </div>
                        </div>
